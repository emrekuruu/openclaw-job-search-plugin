---
name: resume-builder
description: Generate professional resumes from grounded source material. Use when the user wants to create, build, or generate a resume through conversational AI, or when a text-first tailored CV should be converted into structured resume JSON for downstream rendering. This skill guides the agent to ask clarifying questions, avoid hallucination, and produce valid structured output.
---
