...
- `profile.md` — the stable, ground-truth candidate profile. This is the primary source of truth and should preserve the existing candidate profile schema and wording.
...
The older flat sample profile source file was:

- `sample-software-engineer-profile.md`

Its content has been migrated into:

- `sample-software-engineer/profile.md`

The folder-based layout is now the preferred structure for all future profiles.
